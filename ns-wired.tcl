...
# $ns duplex-link $n45 $n46 5Mb 10ms DropTail
# 
# $ns duplex-link $n46 $n47 3Mb 10ms DropTail
# $ns duplex-link $n46 $n48 1Mb 10ms DropTail
# 
# $ns duplex-link $n47 $n49 1Mb 10ms DropTail
# $ns duplex-link $n48 $n49 1Mb 10ms DropTail
# 
# $ns duplex-link $n49 $n50 1Mb 10ms DropTail
# $ns duplex-link $n49 $n51 1Mb 10ms DropTail
# 
# $ns duplex-link $n50 $n52 1Mb 10ms DropTail
# $ns duplex-link $n51 $n52 1Mb 10ms DropTail
#  
# $ns duplex-link $n52 $n53 100Mb 2ms DropTail
# $ns duplex-link $n52 $n54 1Mb 10ms DropTail
# 
# $ns duplex-link $n53 $n55 1Mb 10ms DropTail
# $ns duplex-link $n54 $n56 1Mb 10ms DropTail
# 
# $ns duplex-link $n55 $n57 1Mb 10ms DropTail
# $ns duplex-link $n56 $n57 1Mb 10ms DropTail
# 
# $ns duplex-link $n57 $n58 1Mb 10ms DropTail
# $ns duplex-link $n57 $n59 1Mb 10ms DropTail
# $ns duplex-link $n38 $n47 1Mb 10ms DropTail
# $ns duplex-link $n38 $n48 1Mb 10ms DropTail
# $ns duplex-link $n38 $n49 1Mb 10ms DropTail
...
# $ns duplex-link $n28 $n29 1Mb 10ms DropTail
# 
# $ns duplex-link $n26 $n34 1Mb 10ms DropTail
# $ns duplex-link $n27 $n35 1Mb 10ms DropTail
# $ns duplex-link $n28 $n36 1Mb 10ms DropTail
# $ns duplex-link $n29 $n37 1Mb 10ms DropTail  
# 
# $ns duplex-link $n29 $n39 1Mb 10ms DropTail
# 
# $ns duplex-link $n39 $n50 1Mb 10ms DropTail
# $ns duplex-link $n39 $n51 1Mb 10ms DropTail
# $ns duplex-link $n39 $n52 1Mb 10ms DropTail
# $ns duplex-link $n39 $n53 1Mb 10ms DropTail
# $ns duplex-link $n39 $n54 1Mb 10ms DropTail
# $ns duplex-link $n39 $n55 1Mb 10ms DropTail
# $ns duplex-link $n39 $n56 1Mb 10ms DropTail
# $ns duplex-link $n39 $n57 1Mb 10ms DropTail
# $ns duplex-link $n39 $n58 1Mb 10ms DropTail
# $ns duplex-link $n39 $n59 1Mb 10ms DropTail
...
# $ns attach-agent $n38 $udp
# $ns attach-agent $n39 $udp
# $ns attach-agent $n40 $udp
# $ns attach-agent $n41 $udp
# $ns attach-agent $n43 $udp
# $ns attach-agent $n42 $udp
...
# $ns queue-limit $n45 $n46 20
# Give node position (for NAM)
# $ns duplex-link-op $n0 $n20 orient right-down
# $ns duplex-link-op $n1 $n20 orient right-down
# $ns duplex-link-op $n2 $n20 orient right-down
# $ns duplex-link-op $n3 $n20 orient right
# $ns duplex-link-op $n4 $n20 orient right
# $ns duplex-link-op $n5 $n20 orient right
# $ns duplex-link-op $n6 $n20 orient right-up
# $ns duplex-link-op $n7 $n20 orient right-up
# $ns duplex-link-op $n8 $n20 orient right-up
# $ns duplex-link-op $n9 $n20 orient up
# 
# $ns duplex-link-op $n20 $n21 orient right
# $ns duplex-link-op $n21 $n22 orient right
# $ns duplex-link-op $n23 $n24 orient right
# 
# $ns duplex-link-op $n21 $n30 orient up
# $ns duplex-link-op $n22 $n31 orient up
# $ns duplex-link-op $n23 $n32 orient up
# $ns duplex-link-op $n24 $n33 orient up
...
# $ns attach-agent $n17 $tcp
# $ns attach-agent $n18 $tcp
# $ns attach-agent $n19 $tcp
# $ns attach-agent $n20 $tcp
...
# # $ns attach-agent $n46 $sink
# $ns attach-agent $n47 $sink
# $ns attach-agent $n48 $sink
